...
public class ConstantsBrowser extends ListActivity
  ...
  public void onLoadFinished(Loader<Cursor> loader, Cursor cursor) {
    ...
    // This will commitAllowingStateLoss is allowed from loaders
    getFragmentManager().beginTransaction().replace(R.id.main_details, fragment).commitAllowingStateLoss();
  }
